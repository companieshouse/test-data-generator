...
public class CompanyProfileServiceImpl implements DataService<CompanyProfile> {
    ...
    public CompanyProfile create(String companyNumber) throws DataException {
        ...
        profile.setAccountsNextAccountsPeriodStart(dateNow);
        profile.setAccountsNextAccountsPeriodEnd(dateInOneYear);
        profile.setAccountsNextAccountsDueOn(dateInOneYear);
        profile.setAccountsNextAccountsOverdue(false);
        profile.setAccountsNextMadeUpTo(dateInOneYear);
        profile.setAccountsReferenceDateDay(String.valueOf(now.getDayOfMonth()));
        profile.setAccountsReferenceDateMonth(String.valueOf(now.getMonthValue()));
