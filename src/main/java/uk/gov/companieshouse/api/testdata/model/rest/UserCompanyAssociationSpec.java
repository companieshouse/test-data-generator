...
public class UserCompanyAssociationSpec {
    ...
    private List<InvitationSpec> invitations;
    ...
    public List<InvitationSpec> getInvitations() {
        return invitations;
    }

    public void setInvitations(List<InvitationSpec> invitations) {
