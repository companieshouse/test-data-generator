...
/**
 * Prepends the custom public-company argument resolvers before Spring's built-in ones.
 * <p>
 ...
 * the strict V2 and logging V1 resolvers take priority.
 * </p>
 */
@Component
public class ArgumentResolverConfigurer implements SmartInitializingSingleton {
    ...
    public void afterSingletonsInstantiated() {
        ...
        resolvers.add(new PublicCompanyRequestV1ArgumentResolver());
