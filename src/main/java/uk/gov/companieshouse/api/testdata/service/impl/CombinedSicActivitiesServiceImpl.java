...
@Service
public class CombinedSicActivitiesServiceImpl implements CombinedSicActivitiesService {
    ...
    @Override
    public CombinedSicActivitiesResponse create(CombinedSicActivitiesRequest spec)
    ...
    private CombinedSicActivitiesResponse mapToSicActivitiesData(CombinedSicActivities
                                                                         sicActivity) {
