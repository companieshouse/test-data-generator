...
public interface TestDataService {
    ...
    /**
     * Create company profile data with given {@code spec}.
     *
     * @param spec The specification the new company profile must adhere to
     * @return A {@link CompanyData}
     * @throws DataException If any error occurs
     */
    CompanyData createCompanyProfile(CompanySpecInternal spec, String authorizationHeader ) throws DataException;
