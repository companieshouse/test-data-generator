...
public enum UserRoles {
    ...
    CHS_ADMIN_STRIKE_OFF_OBJECTIONS(
            "chs admin strike off objections", "008a25fe-5cf5-4df7-9091-e94682e4340e"),
    ...
    CHS_ADMIN_FES_USER(
            "chs admin fes user", "c5d61e11-ec3d-4652-ab6c-061cf02868f3"),
    CHS_ADMIN_BULK_REFUNDS(
            "chs admin bulk refunds", "e8448c80-92b1-4170-9cb8-8f8cc436fff1"),
    CHS_ADMIN_ORDERS_INVESTIGATOR(
            "chs admin orders investigator", "e64259bc-282f-48cd-97ed-f9b04ae41827"),
    CHS_ADMIN_INTERNAL_MIDS_PURCHASER(
            "chs admin internal mids purchaser", "407aa1df-f4c6-419f-a68a-a7f8635626c2"),
    CHS_ADMIN_INTERNAL_CERT_DOCS_PURCHASER(
            "chs admin internal cert docs purchaser", "29102f51-ba64-4aa6-ab77-690100b8ba29"),
    CHS_ADMIN_INTERNAL_CERT_PURCHASER(
            "chs admin internal cert purchaser", "25241dbf-3789-4fba-a3d3-32024d479f3b"),
    CHS_ADMIN_SEARCH_IDENTITY_VERIFICATION(
            "chs admin search identity verification", "037b1e7a-9719-4344-8e80-c97d723b2a5b");
