...
public class UserRequest {
    ...
    @Valid
    private List<IdentityVerificationRequest> identityVerification;
    ...
    public List<IdentityVerificationRequest> getIdentityVerification() {
        return identityVerification;
    }

    public void setIdentityVerification(List<IdentityVerificationRequest> identityVerifications) {
