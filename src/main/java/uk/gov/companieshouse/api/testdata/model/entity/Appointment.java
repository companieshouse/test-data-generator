...
public class Appointment {
    ...
    // fixed typo in annotation: use data.identification_type
    @Field("data.identification_type")
    ...
    private Instant appointmentBefore;
    ...
    public Instant getAppointmentBefore() {
        return appointmentBefore;
    }
    public void setAppointmentBefore(Instant appointmentBefore) {
